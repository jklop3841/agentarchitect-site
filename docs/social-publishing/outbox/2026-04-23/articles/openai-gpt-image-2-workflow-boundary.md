# OpenAI 新绘画模型真正的新，不是更会画，而是开始接管图像工作流

ChatGPT Images 2.0 和 API 里的 gpt-image-2，把图像生成从一次性出图推进到可编辑、可推理、可治理的生产链路
...
- https://ai-digest.liziran.com/zh/
- https://ai-digest.liziran.com/zh/feed.xml
